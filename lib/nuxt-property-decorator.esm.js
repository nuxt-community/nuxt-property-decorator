...
import { Emit as Emit$1 } from 'vue-property-decorator';
export { Inject, InjectReactive, Model, Prop, PropSync, Provide, ProvideReactive, Ref, Watch } from 'vue-property-decorator';
...
export { Emit, NextTick, Off, On, Once };
